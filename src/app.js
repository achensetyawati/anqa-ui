...
export class App {
  ...
  configureRouter(config, router) {
    ...
    //   { route: 'anq-tb-bbt', name: 'anq-tb-bbt', moduleId: './modules/anq-tb-bbt-cr/index', nav: true, title: 'Pemasukan Barang Jadi', auth: true, settings: { group: "toko", roles: ["admin"] } },
    //   { route: 'anq-tb-bat', name: 'anq-tb-bat', moduleId: './modules/anq-tb-bat-cr/index', nav: true, title: 'Pemasukan Embalase', auth: true, settings: { group: "toko", roles: ["admin"] } },
    //   { route: 'anq-kb-rtp', name: 'anq-kb-rtp', moduleId: './modules/anq-kb-rtp-cr/index', nav: true, title: 'Retur Barang Ke Pusat', auth: true, settings: { group: "toko", roles: ["admin"] } },
