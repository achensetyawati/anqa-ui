...
const serviceUriStorages = 'master/storages';
...
export class Service extends RestService {
  ...
  getAllRttByFilter(dateFrom, dateTo, status, code) {
    //var config = Container.instance.get(Config);
    //var endpoint = config.getEndpoint("inventory").client.baseUrl + 'docs/anq-kb-rtt/' + dateFrom + "/" + dateTo + "/" + status;
  ...
  getSPKByReference(codeRTT) {
    var config = Container.instance.get(Config);
    var endpoint = config.getEndpoint("merchandiser").client.baseUrl + 'docs/anq-pk/rtt?reference=' + codeRTT;
    return super.get(endpoint);
  }
